...
function gotoDetail(id) {
    var page = '<iframe src="waresDetail.html?id=1" width="100%" height="600" frameborder="0" scrolling="no" name="waresDetail"'
        + 'class="undis" id="waresDetail"></iframe>';
